...
export const AboutPage = () => {
  return (
    <div
      id="about"
      className=" bg-dimSecondaryColor justify-center items-center flex w-full h-full"
    >
      <div className="flex flex-row justify-center items-center  w-3/4 gap-2">
        <section
          className={`${flexBetweeen} flex-col gap-6 p-6 rounded-xl flex bg-dimPrimaryColor`}
        >
          <h1
            className={`${flexBetweeen} font-bold text-2xl text-white self-start`}
          >
            ABOUT ME
          </h1>
          <div
            className={`flex flex-col text-lg text-left  gap-6 text-greyColor`}
          >
            <p>
